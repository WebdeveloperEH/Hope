      ...
      if (
        ...
        if (s.params.loop) {
          ...
          if (slideToIndex > s.slides.length - s.params.slidesPerView) {
            ...
            s.fixLoop();
            var duplicatedSlides = s.wrapper.children(
              "." +
                s.params.slideClass +
                '[data-swiper-slide-index="' +
                realIndex +
            ...
            slideToIndex = duplicatedSlides
              .eq(duplicatedSlides.length - 1)
              .index();
            setTimeout(function () {
              s.slideTo(slideToIndex);
            }, 0);
    ...
    s.getTranslate = function (el, axis) {
      ...
      if (window.WebKitCSSMatrix) {
        ...
        transformMatrix = new window.WebKitCSSMatrix(
          curStyle.webkitTransform === "none" ? "" : curStyle.webkitTransform
        );
      } else {
        transformMatrix =
