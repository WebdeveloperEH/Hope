...
!(function (jQuery, undefined) {
    ...
    for (var o = new Array(), i = 0; i < t.loadMoreItems.length; i++)
      jQuery.each(t.loadMoreItems[i][1], function (e, r) {
        jQuery.each(a, function (e, a) {
          a == r &&
            -1 != t.loadMoreItems[i][0] &&
            (0 == forcesearch ||
              (1 == forcesearch &&
                "cat-searchresult" === t.loadMoreItems[i][2])) &&
            o.push(t.loadMoreItems[i]);
        });
      });
      ...
      if (0 == i.find(".eg-el-amount").length || a > 0) {
        ...
        for (
          ...
          0 == o
            ...
            : -1 != jQuery.inArray(r, t.loadMoreItems[l][1]) &&
  ...
  function buildLoader(e, t, a) {
    return e.find(".esg-loader").length > 0
      ? !1
      : (e.append(
        ...
        ("spinner1" == t.spinner || "spinner2" == t.spinner) &&
          e.find(".esg-loader").css({ backgroundColor: t.spinnerColor }),
  ...
  function loadMoreItems(e, t) {
    ...
    if (o.length > 0) {
      ...
      r.length > 0 &&
        (punchgs.TweenLite.to(r, 0.4, { autoAlpha: 0.2 }),
        r.data("loading", 1));
      var n = {
        ...
        .success(function (a) {
          if (a.success) {
            ...
            jQuery(
              t.filterGroupClass +
                ".esg-filter-wrapper.eg-search-wrapper .eg-forcefilter"
            ).length > 0 && o.addClass("cat-searchresult"),
  ...
  function showHideAjaxContainer(e, t, a, o, i, r) {
    ...
    t
      ? ((i += 1.2),
        ...
        "off" != n.ajaxScrollToOnLoad &&
          jQuery("html, body").animate(
            { scrollTop: e.offset().top - o },
            { queue: !1, speed: 0.5 }
          ))
      : (r && (killOldCustomAjaxContent(e), (s = "0px")),
                ...
                a != undefined &&
                  ...
                  setTimeout(function () {
                    o.data("lastposttype", r),
                      ...
                      o.html(
                        a.func.call(this, { id: i, type: r, aspectratio: n })
                      ),
                      removeLoader(o);
                  }, 300);
            }
    ...
    addCountSuffix(e, t),
      jQuery(
        ...
        e.hasClass("dropdownstyle") &&
          (e.find(".esg-filter-checked").each(function () {
            jQuery(this).prependTo(jQuery(this).parent());
          }),
          is_mobile()
            ? e.find(".esg-selected-filterbutton").click(function () {
                var t = e.find(".esg-selected-filterbutton");
                t.hasClass("hoveredfilter")
                  ? (setTimeout(function () {
      ...
      e.on("itemsinposition", function () {
        ...
        if (
          ...
          p.length > 0 && p.css({ marginTop: 0 - p.height() / 2 }),
            h.length > 0 && h.css({ marginTop: 0 - h.height() / 2 });
  ...
  function prepareSortingClicks(e) {
    ...
    jQuery(
      ...
      jQuery(
        ...
        var a = jQuery(this);
        a.change(function () {
          e.find("iframe").css({ visibility: "hidden" }),
            e.find(".video-eg").css({ visibility: "hidden" });
          var o = jQuery(this)
          ...
          stopAllVideos(!0, !0),
            ...
            e
              .find(".tp-esg-item")
              .tsort({ data: i, forceStrings: "false", order: n }),
            (t = setTimeout(function () {
              (opt = getOptions(e)),
                setItemsOnPages(opt),
                organiseGrid(opt),
  ...
  function waitMediaListeners(e) {
    var t = setInterval(function () {
      e.find("iframe").each(function () {
        var e = jQuery(this);
        e.attr("src").toLowerCase().indexOf("youtube") > 0
          ? prepareYT(e) && clearInterval(t)
          : e.attr("src").toLowerCase().indexOf("vimeo") > 0
          ? prepareVimeo(e) && clearInterval(t)
          : e.attr("src").toLowerCase().indexOf("wistia") > 0
          ? prepareWs(e) && clearInterval(t)
          : e.attr("src").toLowerCase().indexOf("soundcloud") > 0
          ? prepareSoundCloud(e) && clearInterval(t)
          : clearInterval(t);
      }),
        e.find("video").each(function () {
      ...
      t.data("knowndisplay") == undefined &&
        ...
        (e.width() < a && a != undefined) || (e.height() < o && o != undefined)
          ? "visibility" == i
            ...
            : "display" == i && t.addClass("forcenotdisplay")
          : "visibility" == i
          ? t.removeClass("forcenotvisible")
          : "display" == i && t.removeClass("forcenotdisplay");
    });
  }
    ...
    if (
      ...
      0 != e
        ? (a.data("alreadyinoff", !1),
          punchgs.TweenLite.to(a, 0.2, { height: i + e }),
          punchgs.TweenLite.to(o, 0.2, { height: r + e }))
        : a.data("alreadyinoff") ||
  ...
  function itemHoverAnim(e, t, a, o) {
    ...
    if (
      (r.length > 0 && 0 == r.css("opacity") && (i = !0),
    ...
    "set" == t && (n = 0),
      e.data(
        ...
        setTimeout(function () {
          ...
          if (
            (punchgs.TweenLite.set(i, { transformStyle: "flat" }),
  ...
  function videoClickEvent(e, t, a, o) {
    ...
    if ("about:blank" == i.attr("src")) {
      i.attr("src", i.data("src")),
        loadVideoApis(t, a),
        o || punchgs.TweenLite.set(i, { opacity: 0, display: "block" });
            ...
            o ||
              (is_mobile()
                ? (punchgs.TweenLite.set(i, { autoAlpha: 1 }),
                  punchgs.TweenLite.set(n, { autoAlpha: 0 }),
                  punchgs.TweenLite.set(r, { autoAlpha: 0 }))
                : (punchgs.TweenLite.to(i, 0.5, { autoAlpha: 1 }),
                  punchgs.TweenLite.to(n, 0.5, { autoAlpha: 0 }),
                  punchgs.TweenLite.to(r, 0.5, { autoAlpha: 0 }),
                  playYT(i, o))))
          : i.attr("src").toLowerCase().indexOf("vimeo") > 0
          ? 1 == prepareVimeo(i) &&
            (clearInterval(s),
            o ||
              (is_mobile()
                ...
                : (punchgs.TweenLite.to(i, 0.5, { autoAlpha: 1 }),
                  ...
                  punchgs.TweenLite.to(r, 0.5, { autoAlpha: 0 })),
              playVimeo(i, o)))
          : i.attr("src").toLowerCase().indexOf("wistia") > 0
          ? 1 == prepareWs(i) &&
            (clearInterval(s),
            o ||
              (is_mobile()
                ...
                : (punchgs.TweenLite.to(i, 0.5, { autoAlpha: 1 }),
                  ...
                  punchgs.TweenLite.to(r, 0.5, { autoAlpha: 0 }),
                  playYT(i, o))))
          : i.attr("src").toLowerCase().indexOf("soundcloud") > 0 &&
            1 == prepareSoundCloud(i) &&
            (clearInterval(s),
            o ||
              (is_mobile()
                ? (punchgs.TweenLite.set(i, { autoAlpha: 1 }),
      ...
      loadVideoApis(t, a),
        punchgs.TweenLite.set(i, { opacity: 0, display: "block" });
      var s = setInterval(function () {
        1 == prepareVideo(i) &&
          (clearInterval(s),
          o ||
      ...
      o ||
        (is_mobile()
          ...
          : (punchgs.TweenLite.set(i, { opacity: 0, display: "block" }),
            ...
            punchgs.TweenLite.to(n, 0.5, { autoAlpha: 0 }),
            punchgs.TweenLite.to(r, 0.5, { autoAlpha: 0 }))),
        i.attr("src") != undefined &&
          (i.attr("src").toLowerCase().indexOf("youtube") > 0 && playYT(i, o),
        ...
        i.removeClass("eg-newli"),
          ...
          i.find(".esg-media-video").each(function () {
            ...
            if (
              ...
              0 == i.find(".esg-click-to-play-video").length &&
                (i
          ...
          0 == i.find(".esg-media-video").length &&
            i.find(".esg-click-to-play-video").remove(),
          adjustMediaSize(i, !0, null, e),
          i.find(".esg-entry-content").length > 0 &&
            i.find(".esg-media-cover-wrapper").length > 0 &&
            (i.find(".esg-entry-content").index() <
              i.find(".esg-media-cover-wrapper").index() ||
          ...
          e.ajaxContentTarget != undefined &&
            ...
            i.find(".eg-ajaxclicklistener, a").each(function () {
              var t = jQuery(this),
            ...
            if ("mouseenter" === t.type)
              ...
              if (
                ...
                a.find(".esg-entry-content").length > 0 &&
                  ...
                  a.find(".esg-entry-media").css({ height: "100%" }),
                  punchgs.TweenLite.set(a, {
                    z: 0,
                    height: a.data("hhh"),
                    width: a.data("www"),
    ...
    e.find("iframe").length > 0 &&
      e.find("iframe").each(function () {
        ...
        (ifh = (s / r) * n),
          ...
          i.data("newh", ifh),
          t && "even" != o.layout
            ? (punchgs.TweenLite.set(i, { width: s, height: ifh }),
      ...
      e.find(".esg-video-frame").length > 0 &&
        e.find(".esg-video-frame").each(function () {
          var i = jQuery(this);
  ...
  function setItemsOnPages(e) {
    ...
    var w,
      m = Math.ceil(e.nonefiltereditems / o);
  ...
  function removeLLCover(e) {
    !e.hasClass("coverremoved") &&
      e.parent().find(".lazyloadcover").length > 0 &&
      (e.addClass("coverremoved"),
      punchgs.TweenLite.to(e.parent().find(".lazyloadcover"), 0.5, {
        autoAlpha: 0,
        ease: punchgs.Power3.easeInOut,
        onComplete: function () {
  ...
  function runGridMain(e, t) {
    ...
    (r.pageitemcounterfake = 0),
      (r.pageitemcounter = 0),
      (r.delaybasic = e.delayBasic != undefined ? e.delayBasic : 0.08),
    ...
    if (
      ...
      100 == o.find(".esg-overflowtrick").width() &&
        o
          ...
          .css({ width: o.find(".esg-overflowtrick").parent().width() }),
    ...
    "even" == e.layout
      ? ((r.itemh = Math.round(
          0 == Math.round(l) ? r.cwidth_n_spaces / e.column / a : l / e.row
        )),
    ...
    0 == i.length && o.trigger("itemsinposition"),
      jQuery.each(i, function (t, i) {
        var s = jQuery(i);
        if (
          ((r.itemw = r.originalitemw),
          "on" != e.evenCobbles ||
            s.hasClass("itemonotherpage") ||
            s.hasClass("itemishidden"))
        ) {
    ...
    x.length > 0 && punchgs.TweenLite.to(x, 0.2, { autoAlpha: 0 });
  }
  ...
  function animateGrid(e, t, a) {
    ...
    if (
      ...
      for (var i = 0; i < t.column; i++)
        a.currentcolumnheight[a.idealcol] > a.currentcolumnheight[i] &&
          (a.idealcol = i);
    ...
    if (
      ...
      "scale" == a.anim
        ...
        : ("fall" == a.anim || "rotatefall" == a.anim) &&
          ((a.outoffsety = 100), (a = fakePositions(o, a, t)), (a.outfade = 0)),
      "rotatefall" == a.anim
        ? ((a.rotatez = 20),
    ...
    if (
      ...
      punchgs.TweenLite.to(o, a.speed, {
        ...
        o.find(".video-eg").length > 0 &&
          o.find(".video-eg").each(function () {
            var e = jQuery(this),
              a = e.data("neww"),
              i = e.data("newh");
            "even" != t.layout
  ...
  function fakePositions(e, t, a) {
    if (
      ...
      (o == undefined || i == undefined) &&
        ...
        (t.outwaits =
          "rotatefall" == t.anim
            ? (a.column - o) * t.delaybasic + i * t.delaybasic * a.column
            : o * t.delaybasic + i * t.delaybasic * a.column);
    } else;
    return t;
  }
            ...
            jQuery("head")
              ...
              .each(function () {
                jQuery(this).attr("src") ==
                  a + "://www.youtube.com/iframe_api" && (i = !1);
              }),
        ...
        try {
          if (jQuery(this).attr("src").indexOf("ws") > 0 && 0 == o) {
            ...
            jQuery("head")
              ...
              .each(function () {
                jQuery(this).attr("src") ==
                  n + "://fast.wistia.com/assets/external/E-v1.js" && (a = !1);
              }),
        ...
        try {
          if (jQuery(this).attr("src").indexOf("vim") > 0 && 0 == a) {
            ...
            jQuery("head")
              ...
              .each(function () {
                jQuery(this).attr("src") ==
                  n + "://a.vimeocdn.com/js/froogaloop2.min.js" && (o = !1);
              }),
        ...
        try {
          if (jQuery(this).attr("src").indexOf("soundcloud") > 0 && 0 == r) {
            ...
            jQuery("head")
              ...
              .each(function () {
                jQuery(this).attr("src") ==
                  n + "://w.soundcloud.com/player/api.js" && (a = !1);
              }),
              a && t.parentNode.insertBefore(e, t);
          }
        } catch (o) {}
    ...
    e && (o = ""),
      jQuery(".esg-youtubevideo.haslistener" + o).each(function () {
        var t = jQuery(this),
          o = t.data("player");
        a != t.attr("id") &&
          (o.pauseVideo(), e && forceVideoInPause(t, !0, o, "youtube"));
      }),
      ...
      jQuery(".esg-wistiavideo.haslistener" + o).each(function () {
        var t = jQuery(this),
          o = t.data("player");
        a != t.attr("id") &&
          (t.wistiaApi.pause(), e && forceVideoInPause(t, !0, o, "wistia"));
      }),
      ...
      jQuery(".esg-soundcloud" + o).each(function () {
        var t = jQuery(this),
          o = t.data("player");
        a != t.attr("id") &&
          (o.pause(), e && forceVideoInPause(t, !0, o, "soundcloud"));
      });
  }
  function forceVideoInPause(e, t, a, o) {
    ...
    if (
      i.find(".esg-media-video").length > 0 &&
        ...
        if (
          (is_mobile()
            ? (punchgs.TweenLite.set(r, { autoAlpha: 1 }),
              punchgs.TweenLite.set(n, { autoAlpha: 1 }),
              punchgs.TweenLite.set(e, { autoAlpha: 0 }))
            : (punchgs.TweenLite.to(r, 0.5, { autoAlpha: 1 }),
              punchgs.TweenLite.to(n, 0.5, { autoAlpha: 1 }),
      ...
      return (
        ...
        this.each(function () {
          ...
          function a(e, t) {
            ...
            jQuery(window).height() > a &&
              1 != t.data("loading") &&
              (t.data("loading", 1), loadMoreItems(e, o));
          }
          var o = e,
            i = jQuery(this);
          ...
          if (
            ...
            "cobbles" == o.layout
              ? ((o.layout = "even"), (o.evenCobbles = "on"))
              : (o.evenCobbles = "off"),
            "true" != o.get && 1 != o.get)
          ) {
            if (
              ((o.get = !0),
              (o.filterGroupClass =
                o.filterGroupClass == undefined ||
                0 == o.filterGroupClass.length
                  ? "#" + i.attr("id")
                  : "." + o.filterGroupClass),
              1 == window.tplogs)
            )
              try {
                console.groupCollapsed(
                  "Essential Grid  2.0.5 Initialisation on " + i.attr("id")
                ),
            ...
            var n = i
              ...
              .find(".esg-relative-placeholder")
              .offset().left;
            ("on" == o.forceFullWidth || "on" == o.forceFullScreen) &&
              i
                .closest(".esg-container-fullscreen-forcer")
                .css({ left: 0 - n, width: jQuery(window).width() }),
                  ...
                  d &&
                    jQuery.each(d, function (e, t) {
                      (u -= jQuery(t).outerHeight(!0)),
                        u < o.minFullScreenHeight &&
                          (u = o.minFullScreenHeight);
                    });
                } catch (r) {}
              var c = i.find(".esg-overflowtrick").first(),
                p = i.find("ul").first();
              c.css({ display: "block", height: u + "px" }),
                p.css({ display: "block", height: u + "px" }),
                i
  ...
  var vis = (function () {
    ...
    waitForLoads = function (e, t) {
      ...
      jQuery.each(e, function (e, o) {
        (o = jQuery(o)),
          a.length > 0 &&
            punchgs.TweenLite.to(a, 0.2, { autoAlpha: 1, delay: 0.5 }),
          !o.hasClass("loadedmedia") &&
            "even" != t.layout &&
            o.find("img").length > 0 &&
            o.hasClass("itemtoshow") &&
            o.removeClass("itemtoshow").addClass("showmeonload"),
          o.hasClass("loadedmedia") ||
            "even" == t.layout ||
            0 != o.find("img").length ||
            (evenImageRatio(o.find("img"), t), waittorungGrid(o, t, !0));
      });
      var o = setInterval(function () {
        ...
        e.find("img").each(function () {
          ...
          1 != e.data("lazydone") &&
            "on" == t.lazyLoad &&
            e.parent().find(".lazyloadcover").length < 1 &&
            e
              .parent()
              .append(
            ...
            1 != e.data("lazydone") &&
              3 > i &&
              (i++, loadAllPrepared(jQuery(this), t));
        }),
          0 == i &&
            a.length > 0 &&
            (punchgs.TweenLite.killTweensOf(a, !1),
            punchgs.TweenLite.to(a, 0.2, { autoAlpha: 0 })),
          0 != i ||
            e.closest(".mainul").hasClass("gridorganising") ||
            (clearInterval(o), runGrid(t));
      }, 50);
    };
})(jQuery),
  (function (e, t) {
    ...
    function o(e, t) {
      for (var a = 0, o = e.length; o > a; a++) if (e[a] == t) return !i;
      return i;
    }
    var i = !1,
      r = null,
      ...
      e.fn.extend({
        tinysort: function () {
          ...
          for (g = 0, m = arguments.length; m > g; g++) {
            var L = arguments[g];
            p(L)
              ? A.push(L) - 1 > T.length && (T.length = A.length - 1)
              : T.push(L) > A.length && (A.length = T.length);
          }
          for (
            A.length > T.length && (T.length = A.length),
              v = A.length,
              0 === v && ((v = A.length = 1), T.push({})),
              g = 0,
              m = v;
            m > g;
            g++
          ...
          return (
            y.each(function (a, o) {
              ...
              var d = f.call(j, n);
              0 > d && ((d = j.push(n) - 1), (x[d] = { s: [], n: [] })),
                i.length > 0
                  ? x[d].s.push({ s: s, e: r, n: a })
                  : x[d].n.push({ e: r, n: a });
            }),
            h(x, function (e) {
              e.s.sort(Q);
