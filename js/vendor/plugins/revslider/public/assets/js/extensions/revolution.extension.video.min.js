    ...
    checkVideoApis: function (e, t, a) {
      ...
      if (
        ...
        var r = document.createElement("script"),
          ...
          o = !0;
        (r.src = "https://secure-a.vimeocdn.com/js/froogaloop2.min.js"),
          jQuery("head")
            .find("*")
            .each(function () {
    ...
    manageVideoLayer: function (e, o, n, s) {
      ...
      switch (
        ...
        case "html5":
          ...
          var k = "video";
          "html5" == e.data("audio") &&
            ((k = "audio"), e.addClass("tp-audio-html5"));
          var L =
            "<" +
            k +
          ...
          "auto" == c && (o.mediapreload = !0),
            void 0 != m &&
              ...
              (L = L + '<source src="' + m + '" type="video/webm" />'),
            void 0 != g &&
              (L = L + '<source src="' + g + '" type="video/mp4" />'),
            void 0 != f &&
              (L = L + '<source src="' + f + '" type="video/ogg" />'),
            (L = L + "</" + k + ">");
          var V = "";
          ("true" === y || y === !0) &&
            (V =
                  ...
                  if (i.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
                      ...
                      d.globalmute === !0
                        ? f.mute()
                        : (f.unMute(),
                          f.setVolume(parseInt(e.data("volume"), 0) || 75)),
                      (d.videoplaying = !0),
                      u(e, d),
