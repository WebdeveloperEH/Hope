  ...
  jQuery.fn.extend({
        ...
        if (
          ...
          if (a && a.li.length > 0 && (e > 0 || e <= a.li.length)) {
            var n = jQuery(a.li[e]),
              r = n.data("index"),
              o = !1;
            (a.slideamount = a.slideamount - 1),
              removeNavWithLiref(".tp-bullet", r, a),
              removeNavWithLiref(".tp-tab", r, a),
              removeNavWithLiref(".tp-thumb", r, a),
              n.hasClass("active-revslide") && (o = !0),
              n.remove(),
              (a.li = removeArray(a.li, e)),
              a.carousel &&
                a.carousel.slides &&
                (a.carousel.slides = removeArray(a.carousel.slides, e)),
              (a.thumbs = removeArray(a.thumbs, e)),
              _R.updateNavIndexes && _R.updateNavIndexes(a),
              o && t.revnext(),
              punchgs.TweenLite.set(a.li, { minWidth: "99%" }),
              punchgs.TweenLite.set(a.li, { minWidth: "100%" });
          }
        }
      });
    },
    revaddcallback: function (e) {
      return this.each(function () {
        ...
        if (
          ...
          var i = t.parent().find(".tp-bannertimer"),
            a = i.data("opt");
          a.callBackArray === undefined && (a.callBackArray = new Array()),
            a.callBackArray.push(e);
        }
      });
    },
    ...
    revkill: function (e) {
      ...
      if (
        ...
        _R.endMoveCaption &&
          n.endtimeouts &&
          n.endtimeouts.length > 0 &&
          jQuery.each(n.endtimeouts, function (e, t) {
            clearTimeout(t);
          }),
        i != undefined &&
          i.length > 0 &&
  ...
  jQuery.extend(!0, _R, {
    ...
    callingNewSlide: function (e, t, i) {
      ...
      t.find(".next-revslide").removeClass("next-revslide"),
        ...
        (n = t.find(".next-revslide").index()),
        t.trigger("revolution.nextslide.waiting"),
        (a === n && a === e.last_shown_slide) || (n !== a && -1 != n)
          ? swapSlide(t, e)
          : t.find(".next-revslide").removeClass("next-revslide");
    },
  ...
  var _ISM = _R.is_mobile(),
    ...
    waitForScripts = function (e, t) {
      ...
      t.addons != undefined &&
        ...
        ("undefined" != typeof punchgs &&
          i &&
          (!a.kenburns ||
            (a.kenburns && "undefined" != typeof _R.stopKenBurn)) &&
          (!a.navigation ||
            (a.navigation && "undefined" != typeof _R.createNavigation)) &&
          (!a.carousel ||
            (a.carousel && "undefined" != typeof _R.prepareCarousel)) &&
          (!a.videos || (a.videos && "undefined" != typeof _R.resetVideo)) &&
          (!a.actions ||
            (a.actions && "undefined" != typeof _R.checkActions)) &&
          (!a.layeranim ||
            (a.layeranim && "undefined" != typeof _R.handleStaticLayers)) &&
          (!a.migration ||
            (a.migration && "undefined" != typeof _R.migration)) &&
          (!a.parallax ||
            (a.parallax && "undefined" != typeof _R.checkForParallax)) &&
          (a.carousel ||
            (!a.carousel && "undefined" != typeof _R.animateSlide)))
    ...
    runSlider = function (e, t) {
      if (
        ...
        (i.fstransition = a.data("fstransition")),
          (i.fsmasterspeed = a.data("fsmasterspeed")),
          (i.fsslotamount = a.data("fsslotamount"));
        ...
        (h.addedyt = 0),
          ...
          e.find(".tp-caption, .rs-background-video-layer").each(function (e) {
            ...
            p !== undefined && _R.checkActions(i, t, p),
              ...
              _ISM &&
                ((1 == a || "true" == a) &&
                  (i.data("autoplayonlyfirsttime", "false"), (a = !1)),
                (1 == n || "true" == n || "on" == n || "1sttime" == n) &&
                  (i.data("autoplay", "off"), (n = "off"))),
              i.data("videoloop", o),
              r ||
                (1 != a && "true" != a && "1sttime" != n) ||
                "loopandnoslidestop" == o ||
                i
                  .closest("li.tp-revslider-slidesli")
                  .addClass("rs-pause-timer-once"),
              r ||
                (1 != n && "true" != n && "on" != n && "no1sttime" != n) ||
                "loopandnoslidestop" == o ||
                i
                  .closest("li.tp-revslider-slidesli")
            ...
            "always" == t.fallbacks.ignoreHeightChanges
              ? ((t.fallbacks.ignoreHeightChangesSize =
                  t.fallbacks.ignoreHeightChangesSize == undefined
                    ...
                    : t.fallbacks.ignoreHeightChangesSize),
                (i =
                  a != t.lastwindowheight &&
                  Math.abs(a - t.lastwindowheight) >
                    t.fallbacks.ignoreHeightChangesSize))
    ...
    cArray = function (e, t) {
      ...
      if (e.length < t)
        for (var i = e[e.length - 1], a = 0; a < t - e.length + 2; a++)
          e.push(i);
      return e;
    },
            ...
            t.layersonhover &&
              jQuery.each(t.layersonhover, function (e, i) {
                ...
                if (
                  ...
                  a != undefined && (a.pause(0), a.kill()),
                    _R.animateSingleCaption(i, t, n, r, 0, !1, !0);
    ...
    containerResized = function (e, t) {
      if (
        ...
        removeSlots(e, t, e, 2),
          ...
          "on" == a.data("kenburns") &&
            _R.startKenBurn(a, t, a.data("kbtl").progress()),
          "on" == i.data("kenburns") &&
            _R.startKenBurn(i, t, i.data("kbtl").progress()),
          _R.animateTheCaptions &&
            _R.animateTheCaptions(a.closest("li"), t, !0),
          _R.manageNavigation && _R.manageNavigation(t);
      }
    },
    setScale = function (e) {
    ...
    prepareSlides = function (e, t) {
      if (
        ...
        t.allli.each(function (e) {
          ...
          ((t.startWithSlide != undefined && a == t.startWithSlide) ||
      ...
      e.parent().css({ overflow: "visible" }),
        t.allli.find(">img").each(function (e) {
          ...
          a.addClass("defaultvid").css({ zIndex: 30 }),
            ...
            a.appendTo(i.closest("li").find(".slotholder"));
          var n = i.data();
          i.closest(".slotholder").data(n),
            a.length > 0 &&
              n.bgparallax != undefined &&
              a.data("bgparallax", n.bgparallax),
          ...
          var r = i.attr("src");
          (n.src = r),
            (n.bgfit = n.bgfit || "cover"),
            (n.bgrepeat = n.bgrepeat || "no-repeat"),
            (n.bgposition = n.bgposition || "center center");
    ...
    imgLoaded = function (e, t, i) {
      t.syncload--,
        t.loadqueue &&
          jQuery.each(t.loadqueue, function (t, a) {
            ...
            (r = r.substring(0, r.length - 1) + n),
              ...
              (cutParams(o) === cutParams(decodeURIComponent(e.src)) ||
                ...
                ((a.progress = i), (a.width = e.width), (a.height = e.height));
          }),
        progressImageLoad(t);
    },
    ...
    swapSlide = function (e, t) {
      ...
      return a.index() === i.index()
        ...
        : (a.removeClass("next-revslide").addClass("processing-revslide"),
          ...
          void waitForCurrentImages(a, t, function () {
    ...
    swapSlideProgress = function (e, t, i) {
      ...
      (s.nextslide = n),
        ...
        (e.transition = 1),
        (e.videoplaying = !1),
        n.data("delay") != undefined
          ? ((e.cd = 0), (e.delay = n.data("delay")))
          : (e.delay = e.origcd),
        "true" == n.data("ssop") || n.data("ssop") === !0
          ? (e.ssop = !0)
          : (e.ssop = !1),
        i.trigger("nulltimer");
      var d = a.index(),
      ...
      (e.sdir = d > l ? 1 : 0),
        ...
        a.index() != n.index() &&
          ...
          _R.removeTheCaptions(a, e),
        n.hasClass("rs-pause-timer-once") || n.hasClass("rs-pause-timer-always")
          ? (e.videoplaying = !0)
          : i.trigger("restarttimer"),
        n.removeClass("rs-pause-timer-once");
      var u, c;
      if ("carousel" == e.sliderType)
        ...
        (c = new punchgs.TimelineLite({
          ...
          c.pause(),
          1 == e.firststart &&
            (punchgs.TweenLite.set(a, { autoAlpha: 0 }), (e.firststart = 0)),
          punchgs.TweenLite.set(a, { zIndex: 18 }),
          punchgs.TweenLite.set(n, { autoAlpha: 0, zIndex: 20 }),
          "prepared" == n.data("differentissplayed") &&
            (n.data("differentissplayed", "done"),
            n.data("transition", n.data("savedtransition")),
            n.data("slotamount", n.data("savedslotamount")),
            n.data("masterspeed", n.data("savedmasterspeed"))),
          n.data("fstransition") != undefined &&
            "done" != n.data("differentissplayed") &&
            (n.data("savedtransition", n.data("transition")),
          ...
          n.data("transition") == undefined && n.data("transition", "random"),
          (u = 0);
        var p =
            n.data("transition") !== undefined
              ? n.data("transition").split(",")
              : "fade",
          f = n.data("nexttransid") == undefined ? -1 : n.data("nexttransid");
        "on" == n.data("randomtransition")
          ? (f = Math.round(Math.random() * p.length))
          : (f += 1),
          f == p.length && (f = 0),
          n.data("nexttransid", f);
        var h = p[f];
        e.ie &&
          ...
          _R.isIE(8) && (h = 11),
          (c = _R.animateSlide(u, h, i, e, n, a, o, r, c)),
          "on" == o.data("kenburns") &&
            (_R.startKenBurn(o, e),
      ...
      _R.scrollHandling &&
        ...
        _R.animateTheCaptions
          ? _R.animateTheCaptions(n, e, null, c)
          : c != undefined &&
            setTimeout(function () {
              c.resume();
            }, 30),
        punchgs.TweenLite.to(n, 0.001, { autoAlpha: 1 });
    },
    letItFree = function (e, t, i, a, n, r, o) {
      "carousel" === t.sliderType ||
        ...
        a.data("kbtl") != undefined &&
          (a.data("kbtl").reverse(), a.data("kbtl").timeScale(25)),
        "on" == i.data("kenburns") &&
      ...
      var s = {};
      (s.slideIndex = n.index() + 1),
        (s.slideLIIndex = n.index()),
        (s.slide = n),
        (s.currentslide = n),
        (s.prevslide = r),
