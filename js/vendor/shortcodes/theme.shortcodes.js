...
function charity_is_hope_sc_init_actions() {
  ...
  jQuery("body")
    ...
    .on("click", ".close_menuitem, .popup_menuitem", function (e) {
      ...
      if (
        target.hasClass("popup_menuitem") ||
        target.hasClass("close_menuitem") ||
        target.parent().hasClass("close_menuitem")
      ) {
...
function charity_is_hope_sc_init(container) {
  ...
  if (window.charity_is_hope_theme_sc_init)
    charity_is_hope_theme_sc_init(container);
        ...
        .accordion({
          ...
          create: function (event, ui) {
            ...
            if (window.charity_is_hope_init_hidden_elements)
              charity_is_hope_init_hidden_elements(ui.panel);
          ...
          activate: function (event, ui) {
            ...
            if (window.charity_is_hope_init_hidden_elements)
              charity_is_hope_init_hidden_elements(ui.newPanel);
  ...
  if (container.find(".sc_intro[data-href]:not(.inited)").length > 0) {
    container
      .find(".sc_intro[data-href]:not(.inited)")
      .addClass("inited")
      .on("click", function (e) {
        "use strict";
  ...
  if (container.find(".sc_matches:not(.inited)").length > 0) {
    container.find(".sc_matches:not(.inited)").each(function () {
      "use strict";
      jQuery(this)
        .find(".sc_matches_next .sc_matches_list .sc_match")
        .on("click", function () {
          "use strict";
          jQuery(this)
            .parents(".sc_matches")
            .find(".sc_matches_current .sc_match")
            .hide();
  ...
  if (container.find(".sc_players_table:not(.inited)").length > 0) {
    container
      .find(".sc_players_table:not(.inited)")
      .addClass("inited")
          ...
          .done(function (response) {
            ...
            if (rez.error === "") {
              table
                ...
                .after(rez.data)
                .remove();
              charity_is_hope_select_players_category(
                jQuery(table).find(".sc_players_table_category select")
              );
            }
          });
        e.preventDefault();
  ...
  if (container.find(".sc_players_table_category:not(.inited)").length > 0) {
    container
      .find(".sc_players_table_category:not(.inited)")
      .addClass("inited")
      .on("change", function () {
        "use strict";
        ...
        .magnificPopup({
          ...
          callbacks: {
            ...
            open: function () {
              ...
              if (window.charity_is_hope_init_hidden_elements)
                charity_is_hope_init_hidden_elements(jQuery(popup_id));
            },
            close: function () {},
          },
        });
    ...
    container.find(".search_wrap:not(.inited)").each(function () {
      ...
      jQuery(this)
        ...
        .on("blur", ".search_field", function (e) {
          if (
            jQuery(this).val() == "" &&
            !jQuery(this).parents(".search_wrap").hasClass("search_state_fixed")
          )
            jQuery(this)
              .parents(".search_wrap")
              .removeClass("search_state_opened")
                  ...
                  .done(function (response) {
                    ...
                    if (rez.error === "") {
                      ...
                      charity_is_hope_message_warning(
                        CHARITY_IS_HOPE_STORAGE["strings"]["search_error"]
                      );
                    }
                  });
  ...
  if (container.find(".sc_slider_swiper:not(.inited)").length > 0) {
    container.find(".sc_slider_swiper:not(.inited)").each(function () {
      ...
      if (CHARITY_IS_HOPE_STORAGE["swipers"] === undefined)
        CHARITY_IS_HOPE_STORAGE["swipers"] = {};
          ...
          if (!jQuery(this).parent().hasClass("sc_tabs_active")) {
            ...
            jQuery(id_act).fadeOut(function () {
              ...
              jQuery(id).fadeIn(function () {
                ...
                if (window.charity_is_hope_init_hidden_elements)
                  charity_is_hope_init_hidden_elements(jQuery(this));
              });
            });
          }
          e.preventDefault();
      ...
      .on("click", function () {
        ...
        jQuery(this)
          ...
          .slideToggle(300, function () {
            "use strict";
            charity_is_hope_sc_init(
              jQuery(this).parent().find(".sc_toggles_content")
            );
            if (window.charity_is_hope_init_hidden_elements)
              charity_is_hope_init_hidden_elements(
                jQuery(this).parent().find(".sc_toggles_content")
              );
          });
      });
...
function charity_is_hope_sc_init_scroll_area(obj) {
  ...
  if (
    !charity_is_hope_check_images_complete(obj) &&
    CHARITY_IS_HOPE_STORAGE["scroll_init_counter"]++ < 30
  ) {
    setTimeout(function () {
      charity_is_hope_sc_init_scroll_area(obj);
    }, 200);
    return;
  }
...
function charity_is_hope_sc_prepare_slider_navi(slider) {
  ...
  if (false) {
    navi = slider.find(
      "> .sc_slider_controls_wrap, > .sc_scroll_controls_wrap"
    );
    if (navi.length == 0)
      navi = slider.siblings(
        ".sc_slider_controls_wrap,.sc_scroll_controls_wrap"
      );
    if (navi.length > 0) {
      navi
        .on("click", ".sc_slider_prev,.sc_scroll_prev", function (e) {
          var swiper = jQuery(this).parents(".swiper-slider-container");
          if (swiper.length == 0)
            swiper = jQuery(this)
              .parents(".sc_slider_controls_wrap,.sc_scroll_controls_wrap")
              .siblings(".swiper-slider-container");
    ...
    if (eh_items_selector) {
      ...
      eh_wrap.find(eh_items_selector).each(function () {
        ...
        if (row_y < el_offset) {
          if (items.length > 0) {
            if (max_h > 0) {
              for (i = 0; i < items.length; i++) items[i].height(max_h);
            }
            items = [];
            max_h = 0;
          }
  ...
  container.find(".sc_skills_item:not(.inited)").each(function () {
    ...
    if (scrollPosition > scrollSkills) {
      ...
      if (type == "bar") {
        ...
        charity_is_hope_sc_animate_skills_counter(
          start,
          stop,
...
function charity_is_hope_sc_animate_skills_counter(
  start,
  stop,
  speed,
  step,
    ...
    var o = {
      ...
      diagram: function () {
        ...
        r.circle(c, c, Math.round(w / 2)).attr({
          stroke: "none",
          fill: CHARITY_IS_HOPE_STORAGE["theme_bg_color"]
            ? CHARITY_IS_HOPE_STORAGE["theme_bg_color"]
            : "#ffffff",
        });
        ...
        var title = r
          ...
          .attr({
            font:
              Math.round(rad * 0.75) +
              'px "' +
              CHARITY_IS_HOPE_STORAGE["theme_font"] +
              '"',
            fill: CHARITY_IS_HOPE_STORAGE["theme_color"]
              ? CHARITY_IS_HOPE_STORAGE["theme_color"]
              : "#909090",
          })
          .toFront();
  ...
  if (!form_custom) {
    ...
    if (form.find('[name="subject"]').length > 0) {
      rule = {
        ...
        max_length: {
          value: 100,
          message: CHARITY_IS_HOPE_STORAGE["strings"]["subject_long"],
        },
      };
      if (form.find('[name="subject"][aria-required="true"]').length > 0)
        rule["min_length"] = {
          value: 1,
          message: CHARITY_IS_HOPE_STORAGE["strings"]["subject_empty"],
        };
      rules.push(rule);
    }
    ...
    if (form.find('[name="message"]').length > 0) {
      rule = {
        field: "message",
        max_length: {
          value: CHARITY_IS_HOPE_STORAGE["contacts_maxlength"],
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          ...
          result
            ...
            .html(CHARITY_IS_HOPE_STORAGE["strings"]["send_complete"]);
          ...
          result
            ...
            .html(
              CHARITY_IS_HOPE_STORAGE["strings"]["send_error"] + " " + rez.error
            );
        }
...
function charity_is_hope_select_players_category(sel) {
  ...
  if (value == "all") jQuery(table).find(".sc_table tr:nth-child(n+2)").show();
  else {
    ...
    jQuery(table)
      ...
      .each(function () {
        ...
        if (cat != null && cat.indexOf(value) != -1) jQuery(this).show();
      });
  }
}
...
function charity_is_hope_menuitems_show_popup(obj) {
  ...
  jQuery("#page_preloader")
    .data("bg-color", jQuery("#page_preloader").css("background-color"))
    .css({ display: "block", opacity: 0, backgroundColor: "transparent" })
  ...
  if (CHARITY_IS_HOPE_STORAGE["menuitems_list"].length == 0) {
    ...
    CHARITY_IS_HOPE_STORAGE["menuitems_list"] =
      CHARITY_IS_HOPE_STORAGE["menuitems"][menuitems_list_id].split(",");
  }
  ...
  jQuery
    ...
    .done(function (response) {
      ...
      try {
        ...
        rez = {
          error: CHARITY_IS_HOPE_STORAGE["ajax_error"] + "<br>" + response,
        };
      }
      ...
      if (rez.error === "") {
        ...
        if (jQuery(".popup_menuitem").length == 0) {
          jQuery("body").append(
            '<div id="overlay"></div><div class="popup_menuitem"></div>'
          );
        ...
        setTimeout(function () {
          ...
          jQuery(".popup_menuitem .sc_menuitems_wrap").append(
            "<a class='close_menuitem' href='#'><span class='icon-cancel'></span></a>"
          );
          if (CHARITY_IS_HOPE_STORAGE["menuitems_list"].length > 1) {
            var idx = 0;
            for (
              var i = 0;
              i < CHARITY_IS_HOPE_STORAGE["menuitems_list"].length;
              i++
            ) {
              if (
                CHARITY_IS_HOPE_STORAGE["menuitems_list"][i] === menuitem_id
              ) {
                idx = i;
                break;
              }
            ...
            var prev =
              (idx - 1 + CHARITY_IS_HOPE_STORAGE["menuitems_list"].length) %
              CHARITY_IS_HOPE_STORAGE["menuitems_list"].length;
            var next =
              (idx + 1) % CHARITY_IS_HOPE_STORAGE["menuitems_list"].length;
            jQuery(
              ".popup_menuitem .sc_menuitems_wrap .sc_menuitem_content"
            ).append(
              "<a class='prev_menuitem prevnext_menuitem show_popup_menuitem' rel='" +
                CHARITY_IS_HOPE_STORAGE["menuitems_list"][prev] +
                "'  href='#'><span class='icon-left'></span></a>" +
                "<a class='next_menuitem prevnext_menuitem show_popup_menuitem' rel='" +
                CHARITY_IS_HOPE_STORAGE["menuitems_list"][next] +
                "'  href='#'><span class='icon-right'></span></a>"
            );
          }
